# Preparing the final complete JavaScript code for the Nova X Assistant app
final_js_code = """
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  // Image OCR Button (below task panel)
  const analyzeImageBtn = document.getElementById("analyze-image-button");
  if (analyzeImageBtn) {
    analyzeImageBtn.addEventListener("click", async () => {
      ...
      input.onchange = async (event) => {
        ...
        addMessage("You", "🧠 Analyzing image...", "user-message");
        ...
        try {
          ...
          reader.onload = async () => {
            ...
            addMessage("You", `📝 Extracted Text: \${text.trim()}`, "user-message");
          ...
          addMessage("Nova X", "❌ Error analyzing image.");
        }
      };
      input.click();
    });
...
final_js_code[:3000]  # Display the first 3000 characters of the complete JS code
